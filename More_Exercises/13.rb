...
def find contact_data, contacts, counter, final_array
  ...
  if counter < (contacts.length) - 1
      counter +=1
      find contact_data, contacts, counter, final_array
  end
  return final_array
end

final_array = []
find contact_data, array, 0, final_array 
p final_array
joe = final_array[0]
joe_info = joe["Joe Smith"]
p joe_info[0]
sally = final_array[1]
sally_info = sally["Sally Johnson"]
p sally_info[2]